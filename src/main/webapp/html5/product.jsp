                    ...
                    <div class="noi_dung">
                        ...
                        <c:if test="${client.role==1}">
                            <c:if test="${cars.status==1}">
                                <p>
                                    <button><a href="/addToCart?carID=${cars.carID}&&email=${client.email}"
                                               style="text-decoration: none">Add to Cart</a></button>
                                </p>
                            </c:if>
                            <c:if test="${cars.status==2}">
                                <p>
                                    <button><a href="#" style="text-decoration: none">Ordered</a></button>
                                </p>
                            </c:if>
                        </c:if>
                        <c:if test="${client.role==2}">
                            <div>
                                <button type="button" class="btn btn-dark"
                                        style="width: 35%;float: left;margin-left: 30px;"><a
                                        href="/carEdit?carID=${cars.carID}" style="text-decoration: none;color: white">Edit</a>
                                </button>
                                <button type="button" class="btn btn-warning"
                                        style="width: 35%;float: left;margin-left: 20px;"><a
                                        href="/viewDeleteCar?carID=${cars.carID}"
