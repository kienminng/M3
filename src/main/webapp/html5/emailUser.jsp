          ...
          <ul class="list-group shadow">
            <li class="list-group-item">
              ...
              <div class="form-outline">
                ...
                <c:if test="${list.content!=null}">
                  <input type="text" id="form3Example1n" class="form-control form-control-lg" name="content" value="${client.content} readonly"/>
                  <label class="form-label" for="form3Example1n">Evaluate</label>
                </c:if>
              </div>
              <c:if test="${list.content==null}">
                <div class="d-flex justify-content-end pt-3" style="float: right">
                  <a href="/updateContent?carID=${list.carID}" class="btn btn-dark">Send</a>
